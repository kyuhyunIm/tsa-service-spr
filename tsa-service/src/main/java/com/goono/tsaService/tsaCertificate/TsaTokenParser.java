...
public class TsaTokenParser {
    public TsaCertificate parse(String inputBase64) throws Exception {
        ...
        ASN1Sequence tsInfo = (ASN1Sequence) ((ASN1TaggedObject) ((ASN1Sequence) signedData.getObjectAt(2)).getObjectAt(1)).getObject();

        // 해시 알고리즘
        ASN1ObjectIdentifier hashAlgOID = (ASN1ObjectIdentifier) ((ASN1Sequence) ((ASN1Sequence) tsInfo.getObjectAt(2)).getObjectAt(0)).getObjectAt(0);
        ...
        ASN1OctetString signedAttr = (ASN1OctetString) ((ASN1TaggedObject) ((ASN1Sequence) signerInfo.getObjectAt(3)).getObjectAt(2)).getObject();
    ...
    private static String extractHashFromDecrypted(String decryptedHex) throws IOException {
        ...
        if (!matcher.find()) throw new IOException("패딩 제거 실패");
